...
const avatarWebm = "/imports/ai-receptionist-avatar.webm";
const avatarMp4 = "/imports/ai-receptionist-avatar.mp4";
const avatarFallbackPng = "/imports/avatar-fallback.png";

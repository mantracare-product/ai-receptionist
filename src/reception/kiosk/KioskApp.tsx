...
export default function KioskApp() {
  ...
  const [deviceToken, setDeviceToken] = useState<string | null>(() => {
    return (typeof window !== "undefined" ? localStorage.getItem("ma_kiosk_device_token") : null);
  });
  const [deviceId, setDeviceId] = useState<string | null>(() => {
    return (typeof window !== "undefined" ? localStorage.getItem("ma_kiosk_device_id") : null);
  });
